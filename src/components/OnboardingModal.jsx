...
export default function OnboardingModal({ onComplete }) {
  ...
  // Cek pas pertama kali load, apakah udah ada profilnya?
  useEffect(() => {
    const profile = localStorage.getItem("magang-profile");
    if (!profile) {
      setIsOpen(true); // Kalau belum ada, buka pop-up nya!
    }
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("magang-profile", JSON.stringify(formData));
    setIsOpen(false);
